package com.toy.moviemate.security.listener;
...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void setupData() {
        ...
        roles.add(adminRole);
        createUserIfNotFount("admin", "admin@admin.com", "pass", roles);
    }
    ...
    public void createUserIfNotFount(final String userName, final String email, final String password, Set<Role> roleSet) {
